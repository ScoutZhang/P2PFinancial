        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav" style="margin-top: 1%">
                    ...
                    <li class="active"><a href="/investmentOverview?investNum=3">等额本金</a></li>
...
<div class="parallax-pro">
    <div class="img-src" style="background-image: url('/static/img/index_1.jpg');"></div>
    <div class="container">
        ...
        <div class="col-md-6">
            <div class="card card-user">
                <div class="text-center">
                    ...
                    <hr>
                    <div class="text-center">
                        <p class="h1" style="color: #ec971f;">11%</p><h5><small>预期年化利率</small></h5>
                    </div>
                    <div class="space-30"></div>
                    <hr>
                    <div class="actions">
                        <a class="btn btn-lg btn-warning btn-fill" href="/investmentDetail?investmentRepayment=acm&investmentHorizon=180&annualInterestRate=0.11&interestExpiryDate=monthly&investmentCompound=f&principal=10000">查看详情</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card card-user">
                <div class="text-center">
                    ...
                    <hr>
                    <div class="text-center">
                        <p class="h1" style="color: #ec971f;">12%</p><h5><small>预期年化利率</small></h5>
                    </div>
                    <div class="space-30"></div>
                    <hr>
                    <div class="actions">
                        <a class="btn btn-lg btn-warning btn-fill" href="/investmentDetail?investmentRepayment=acm&investmentHorizon=360&annualInterestRate=0.12&interestExpiryDate=monthly&investmentCompound=f&principal=10000">查看详情</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <form id="calculatorForm">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <input name="investmentRepayment" type="hidden" value="acm" class="form-control">
                            </div>
                            <div class="form-group">
